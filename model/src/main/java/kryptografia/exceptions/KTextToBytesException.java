...
///
public class KTextToBytesException extends KException {
    public KTextToBytesException(String message) {
        super(message);
    }
    public KTextToBytesException(String message, Throwable cause) {
        super(message, cause);
    }
}
