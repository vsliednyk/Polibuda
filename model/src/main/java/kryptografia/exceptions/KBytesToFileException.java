...
///
public class KBytesToFileException extends KException {
    public KBytesToFileException(String message) {
        super(message);
    }
    public KBytesToFileException(String message, Throwable cause) {
        super(message, cause);
    }
}
